...
const PLANS = [
  {
    ...
    features: [
      ...
      'Brainstorm de ideias e próximos passos pela IA',
      'Plano de desdobramento do que foi discutido',
      '12 horas de áudio por mês',
      'Assistente de IA',
    ],
    highlight: false,
  },
  {
    ...
    annualTotal: 799,
    features: [
      'Transcrição clínica de consultas, com separação de falantes',
      'Pacientes e prontuário',
      'Resumo clínico, sintomas e condutas pela IA',
      '15 horas de áudio por mês',
      'Assistente de IA',
    ],
    highlight: false,
  },
